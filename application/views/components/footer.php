	...
	<script src="<?php echo base_url() ?>assets/src/plugins/highcharts-6.0.7/code/highcharts-3d.js"></script>
	...
	<script src="<?php echo base_url() ?>assets/jsFile/<?php echo $jsFile ?>.js"></script>
</body>
</html>
