	...
	<div class="header">
		<div class="header-left">
			...
			<div class="header-search">
				Selamat Datang, <b><?= $this->session->userdata('name') ?></b>
				<!-- <form>
		...
		<div class="header-right">
			<div class="user-info-dropdown">
				<div class="dropdown">
					<a class="dropdown-toggle no-arrow" href="<?= base_url() ?>auth/logout" role="button" style="padding: 9px 0px;">
						<!-- <span class="user-icon">
							<img src="assets/vendors/images/photo1.jpg" alt="">
						</span> -->
						<span class="user-icon" style="background: transparent; color: black; box-shadow: none; width: 25px; height: 42px;">
							<i class="dw dw-logout" style="font-size: 30px;"></i>
						</span>
			...
			<!-- <div class="dashboard-setting user-notification">
				<div class="dropdown">
					<a class="dropdown-toggle no-arrow" href="javascript:;" data-toggle="right-sidebar">
						<i class="dw dw-settings2"></i> <span class="user-name">Logout</span>
					</a>
				</div>
			</div>
