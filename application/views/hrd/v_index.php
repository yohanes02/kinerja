				...
				<!-- <div class="col-xl-4 mb-30">
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center">
							...
							<div class="widget-data">
								<div class="h4 mb-0"><?php //$sumDepartment?></div>
			...
			<div class="row">
				<div class="col-xl-8 mb-30">
					<div class="card-box height-100-p pd-20">
						<h2 class="h4 mb-20">Gender Berdasarkan Bagian</h2>
						<div id="chart-gender-department"></div>
					</div>
				</div>
				<div class="col-xl-4 mb-30">
					<div class="card-box height-100-p pd-20">
						<h2 class="h4 mb-20">Persentase Gender Keseluruhan</h2>
						<!-- <div id="chart6"></div> -->
