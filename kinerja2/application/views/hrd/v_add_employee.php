	...
	<div class="container-fluid">
		...
		<div class="col-md-12">
			<div class="white_shd full margin_bottom_30">
				...
				<form action="<?=base_url()?>hrd/submitNewEmployee" method="post">
					<div class="full">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="input-group date" id="datetimepicker2" data-target-input="nearest">
											<input type="text" class="form-control datetimepicker-input" data-target="#datetimepicker2" name="join_date"/>
